...
Plot (??) shows the two integrands in equation \ref{eq:ints}. Because the curvature of the integrand strongly depends on $u$ I chose to use a (recursive) adaptive Simpson's method as my numerical integration procedure. A
\subsection{Runtime}
\label{rt}
